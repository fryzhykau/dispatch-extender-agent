# install-worker.ps1
# Registers the Dispatch Worker as a Windows service using NSSM.

param(
    [string]$ProjectRoot = (Resolve-Path (Join-Path $PSScriptRoot "..")).Path
)

$ServiceName = "DispatchWorker"
$EntryScript = "worker\agent-relay.js"
$AppDirectory = Join-Path $ProjectRoot "worker"
