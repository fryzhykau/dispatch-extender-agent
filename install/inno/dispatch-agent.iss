...
; Build:    Run install/inno/build.ps1 -Target agent
; ==========================================================================
...
Source: "..\install-worker.ps1"; DestDir: "{app}\install";   Flags: ignoreversion
Source: "..\generate-certs.ps1"; DestDir: "{app}\install";   Flags: ignoreversion

; Agent setup wizard
Source: "agent-setup-wizard.ps1";        DestDir: "{app}\install\inno"; Flags: ignoreversion
Source: "launch-agent-wizard.ps1";       DestDir: "{app}\install\inno"; Flags: ignoreversion
...
Source: "assets\agent-icon.ico";         DestDir: "{app}\install\inno\assets"; DestName: "icon.ico"; Flags: ignoreversion

; Diagram for agent setup wizard welcome page
Source: "..\..\docs\images\agent-diagram-simple.png"; DestDir: "{app}\install\inno\assets"; DestName: "agent-diagram.png"; Flags: ignoreversion
...
Name: "{group}\Agent Setup"; Filename: "powershell.exe"; \
  Parameters: "-ExecutionPolicy Bypass -File ""{app}\install\inno\agent-setup-wizard.ps1"""; \
...
Name: "{autodesktop}\Agent Setup"; Filename: "powershell.exe"; \
  Parameters: "-ExecutionPolicy Bypass -File ""{app}\install\inno\agent-setup-wizard.ps1"""; WorkingDir: "{app}"; \
...
Filename: "powershell.exe"; \
  Parameters: "-ExecutionPolicy Bypass -File ""{app}\install\inno\launch-agent-wizard.ps1"""; \
